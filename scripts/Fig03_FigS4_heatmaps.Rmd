...
#Genera
 ...
 labs(y = "Genera", fill = "% relative\n abudance",
  ...
  ggsave(plot,filename="output/FigS2_Heatmap_core_genera.png", width=12, height=14)
ggsave(plot ,filename="output/FigS2_Heatmap_core_genera.pdf", width=12, height=14, useDingbats=FALSE, limitsize=FALSE)
```
