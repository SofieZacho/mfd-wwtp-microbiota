---
title: 'Figure S8: Distance decay'
...
ggsave(p,filename = "output/FigS8_DDR-ASall_Bray&Sor_gen_spp.jpeg", height = 7, width = 12.5)
ggsave(p,filename = "output/FigS8_DDR-ASall_Bray&Sor_gen_spp.pdf", height = 7, width = 12.5,
