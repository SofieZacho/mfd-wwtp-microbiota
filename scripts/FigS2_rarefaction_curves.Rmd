...
## rarecurves
d_test <- amp_subset_samples(d_rep,
                             SampleContent %in% 'AS')

AS_rare <- amp_rarecurve(d_test, 
...
ggsave('output/FigSxx_rarefaction_curves_AS.png', AS_rare,
       width = 15, height = 15)
ggsave(filename="output/FigSxx_rarefaction_curves_AS.pdf", 
       AS_rare,
...
ggsave('output/FigSxx_rarefaction_curves_IWW.png', IWW_rare,
       width = 15, height = 15)
ggsave(filename="output/FigSxx_rarefaction_curves_IWW.pdf", 
       IWW_rare,
       width = 15, height = 15, useDingbats=FALSE, limitsize=FALSE)
