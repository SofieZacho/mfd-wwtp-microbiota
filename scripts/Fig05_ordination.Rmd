...
p_region <- ggplot(pcoa_as_bray$data, aes(x = PCo1, y = PCo2)) +
  geom_point(aes(fill = Region), size=2.5, shape = 21, alpha = 1)+
  ylim(-0.34,0.34)+
...
p_design <- ggplot(pcoa_as_bray$data, aes(x = PCo1, y = PCo2)) +
  geom_point(aes(fill = Design), size=2.5, shape = 21, alpha = 1) +
...
p_pe <- ggplot(pcoa_as_bray$data, aes(x = PCo1, y = PCo2)) +
  geom_point(aes(fill = PEdesign/1000), size=2.5, shape = 21, alpha = 1) +
...
p_load <- ggplot(pcoa_as_bray$data, aes(x = PCo1, y = PCo2)) +
  geom_point(aes(fill = `IndustrialLoad[%]`), size=2.5, shape = 21, alpha = 1) + ylim(-0.33,0.33)+
