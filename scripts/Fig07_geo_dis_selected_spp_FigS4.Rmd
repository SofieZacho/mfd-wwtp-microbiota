---
title: 'Figure 7 + Figure S4: Geographical distribution'
...
map_func <- function(x) {
  m + geom_point(data = heat_as_spp_t,
                 ...
                 colour = 'black' ) +
    xlim(8,12.8) +
    scale_fill_binned(breaks = c(0,0.001,0.1, 1),
                      na.value = 'white',
                      guide = guide_coloursteps(frame.color = 'black'),
                      palette = ggplot2:::binned_pal(scales::manual_pal(values = cols)))+
    theme(legend.position = 'none',
          title = element_text(size = 10),
          legend.title = element_blank(),
          legend.text = element_text(size = 3, angle = 90),
          legend.key.size = unit(0.3, 'cm'), #0.2
...
iww_map_func <- function(x) {
  m + geom_point(data = heat_as_spp_t,
                 ...
                 colour = 'black' ) +
    xlim(8,12.8) +
    scale_fill_binned(breaks = c(0,0.001, 0.01),
                      na.value = 'white',
                      guide = guide_coloursteps(frame.color = 'black'),
...
ggsave(filename = "output/Fig07_supplementary.png",
         sup,
         width = 8, height = 4)
ggsave(filename = "output/Fig07_supplementary.pdf",
         sup,
         width = 8, height = 4, useDingbats=FALSE, limitsize=FALSE)
