---
title: 'Figure S10: Distance decay for core and CRAT'
...
p <- plot_grid(p_AS_bray + labs(tag= 'A')+ theme(plot.tag = element_text(face='bold')), 
                      ...
                      nrow = 2,
                      rel_widths = c(1, 1))
ggsave(filename = "output/FigS10_DDR_ASV_core.jpeg", height = 7, width = 7,limitsize=FALSE)
ggsave(filename = "output/FigS10_DDR_ASV_core.pdf", height = 7, width = 7, useDingbats=FALSE, limitsize=FALSE)
```
